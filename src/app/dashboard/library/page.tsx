...
export default async function LibraryPage() {
  ...
  if (!(await isAdmin())) redirect('/dashboard')   // Players can't access the Library
        ...
        <div className="mb-8 p-4 rounded-xl border border-amber-900/25 bg-amber-900/10 flex gap-3">
          ...
          <div className="text-sm">
            ...
            <p className="text-foreground/50 leading-relaxed">
              ...
              El <strong className="text-parchment-300">Oracle</strong> (creación de personajes) y el 
              <strong className="text-parchment-300"> Game Master</strong> (sesión de juego) los leerán 
              automáticamente para aplicar las reglas oficiales de D&D 5E.
            </p>
          </div>
        </div>
